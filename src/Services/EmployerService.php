...
/**
 * Implementación del servicio de datos de empleador (patrón).
 * Opera sobre el sub-recurso /people/{personId}/employer
 */
class EmployerService implements EmployerServiceInterface
{
    ...
    protected string $subResourcePath = 'employer';

    /**
     * Constructor del servicio de empleador
     *
    ...
    /**
     * Construye la URL del sub-recurso: /people/{personId}/employer
     *
